function newton2(zRoots, domain, eps, m, nIteration, cmap)
...
% 
% zRoots - wektor pierwiastków wielomianu
...
%
% Domyślne wartości - 
% zRoots: roots([1 0 0 -1]) - pierwiastki równania x^3 - 1
% domain: [-2 -2 2 2]
% eps: 1e-13
% m: 500
% nIteration: 50
...
%
% zRoots - vector of roots of a polynomial
...
%
% Default values - 
% zRoots: roots([1 0 0 -1]) - roots of x^3 - 1
% domain: [-2 -2 2 2]
% eps: 1e-13
% m: 500
% nIteration: 50
